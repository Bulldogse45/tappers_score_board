...
user = User.create([{:email => "matt@gmail.com", :name => "admin", :password => "password", :password_confirmation => "password"},
                    {:email => "ben@gmail.com", :name => "admin", :password => "password", :password_confirmation => "password"}
                    ])
...
group_membership = GroupMembership.create([ {group_id: 1, user_id: 1, commissioner: true},
                                            {group_id: 2, user_id: 1, commissioner: true}
                                          ])
